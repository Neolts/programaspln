...
def convertir_audio_a_texto(nombre_archivo):
    ...
    try:
        ...
        # Preguntar si desea escuchar el texto reconocido
        respuesta = input("¿Desea escuchar el texto reconocido? (Sí/No): ").lower()
        if respuesta == "sí" or respuesta == "si":
            ...
            if platform.system() == "Windows":
                ...
                os.system("espeak '" + texto + "'")
        else:
            print("Texto no reproducido.")
